...
/**
 * Servlet implementation class ProductAnalysis
 */
@WebServlet(urlPatterns="/ProductAnalysis",asyncSupported=true)
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		executor.execute(new Runnable() {
			...
			public void run() {
				...
				exec(Path.nonstreamclient,product,brand,response);
			}
		});
	}
