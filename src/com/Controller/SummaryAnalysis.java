...
/**
 * Servlet implementation class SummaryAnalysis
 */
@WebServlet(urlPatterns="/SummaryAnalysis",asyncSupported=true)
public class SummaryAnalysis extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		executor.execute(new Runnable() {
			...
			public void run() {
				...
				exec(Path.summaryPath,url,response);
			}
		});
	}
